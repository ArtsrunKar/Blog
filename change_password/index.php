        ...
        <div class="container">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <span style="color: red" class="error"><?php echo $error['current_pass_err'];
                        echo $error['current_pass_empty_err']; ?></span>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <span style="color: red" class="error"><?php echo $error['new_pass_err'];
                        echo $error['retype_new_pass_empty_err']; ?></span>
                </div>
